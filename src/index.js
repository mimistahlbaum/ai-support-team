...
import { bootstrapDiscordClients, registerGracefulShutdown } from './app/bootstrap.js';
...
registerGracefulShutdown({ clients: [scout, spark, forge, mirror, coordinator], healthServer });
